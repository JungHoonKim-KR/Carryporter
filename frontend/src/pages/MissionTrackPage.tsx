        ...
        <div className="min-h-screen bg-gray-50">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-toss-blue-500 rounded-xl flex items-center justify-center">
                                <img src="/images/logo.png" alt="CARRY PORTER Logo" className="w-6 h-6 object-contain brightness-0 invert" />
                            </div>
            ...
            <main className="max-w-md mx-auto px-6 py-6">
                ...
                <div className="mb-6 animate-fade-in-up">
                    <h2 className="text-gray-900 text-2xl font-bold mb-1">미션 진행중 🚀</h2>
                ...
                >
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <TimelineStep label="요청됨" active={status === "REQUESTED"} completed={status !== "REQUESTED"} />
                            <TimelineStep label="로봇 배정" active={status === "ASSIGNED"} completed={["MOVING", "ARRIVED", "UNLOCKED", "LOCKED", "RETURNING", "RETURNED", "FINISHED"].includes(status)} />
                            <TimelineStep label="이동 중" active={status === "MOVING"} completed={["ARRIVED", "UNLOCKED", "LOCKED", "RETURNING", "RETURNED", "FINISHED"].includes(status)} />
                            <TimelineStep label="도착" active={status === "ARRIVED"} completed={["UNLOCKED", "LOCKED", "RETURNING", "RETURNED", "FINISHED"].includes(status)} />
                            <TimelineStep label="완료" active={status === "FINISHED"} completed={status === "FINISHED"} />
                        </motion.div>
                    </AnimatePresence>
                </motion.div>
                    ...
                    <div className="bg-white rounded-2xl p-5 shadow-sm mb-6 animate-fade-in-up">
                        ...
                        <div className="bg-gray-50 rounded-xl p-4 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-900 text-xl font-bold">{currentMission.robotCode}</p>
                            </div>
                        </div>
                    </div>
                )}
